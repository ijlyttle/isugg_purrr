---
title: "Using purrr: weird data-frames - http://ijlyttle.github.io/isugg_purrr/presentation.html - [source](http://ijlyttle.github.io/isugg_purrr/presentation.Rmd)"
...
- this seems like a stronger expression of the `group_by()` idea in dplyr
...
## Step: `map_df` to build the models
...
The `tidy()` function extracts statistics from the model
